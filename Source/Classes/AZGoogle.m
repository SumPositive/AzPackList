...
- (GTMOAuth2Authentication *)myCustomAuth 
{
	GTMOAuth2Authentication *auth = [GTMOAuth2Authentication 
									 authenticationWithServiceProvider:@"Custom Auth Service" 
									 tokenURL:@""
									 redirectURI:@"urn:ietf:wg:oauth:2.0:oob"
									 clientID:@"27136904860.apps.googleusercontent.com"
									 clientSecret:@"dnvbn1az5x6DtxCEi7BuAPQD"];
	
    return auth;
}

//- (void)signInWithAuth:(GTMOAuthAuthentication *)auth 
- (void)signInWithAuth:(GTMOAuth2Authentication *)auth 
{
	mAuth = nil;
    ...
    viewController = [[GTMOAuth2ViewControllerTouch alloc]
					  initWithScope:@"http://api.twitter.com/oauth/request_token" 
					  clientID:@"27136904860.apps.googleusercontent.com" 
					  clientSecret:@"dnvbn1az5x6DtxCEi7BuAPQD" 
					  keychainItemName:GD_PRODUCTNAME 
					  completionHandler:
